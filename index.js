...
var _user$project$Main$toUrl = function (stream) {
	var _p0 = stream;
	if (_p0.ctor === 'Just') {
		return A2(
...
var _user$project$Main$navigate = function (stream) {
	return _elm_lang$navigation$Navigation$newUrl(
		_user$project$Main$toUrl(stream));
};
var _user$project$Main$parseRoute = function (location) {
	return A2(_elm_lang$core$String$startsWith, '?stream=', location.search) ? _elm_lang$http$Http$decodeUri(
		A2(_elm_lang$core$String$dropLeft, 8, location.search)) : _elm_lang$core$Maybe$Nothing;
};
var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$activityView = function (activity) {
	return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(activity.summary),
							_1: {
								ctor: '::',
								_0: A2(
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(activity.published),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Main$streamView = function (stream) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(stream.summary),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							A2(_elm_lang$core$List$map, _user$project$Main$activityView, stream.orderedItems)),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Main$Stream = F4(
	function (a, b, c, d) {
		return {context: a, summary: b, type_: c, orderedItems: d};
	});
var _user$project$Main$Activity = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, type_: b, published: c, actor: d, summary: e, object: f, target: g};
	});
var _user$project$Main$Actor = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$Main$decodeActor = A3(
	...
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Actor)));
var _user$project$Main$Object = F2(
	function (a, b) {
		return {id: a, content: b};
	});
var _user$project$Main$decodeObject = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'content',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Object)));
var _user$project$Main$Target = F2(
	function (a, b) {
		return {type_: a, name: b};
	});
var _user$project$Main$decodeTarget = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'name',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'type',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Target)));
var _user$project$Main$decodeActivity = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'target',
	_user$project$Main$decodeTarget,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'object',
		_user$project$Main$decodeObject,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'summary',
			_elm_lang$core$Json_Decode$string,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'actor',
				_user$project$Main$decodeActor,
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'published',
					_elm_lang$core$Json_Decode$string,
					A3(
						...
						A3(
							...
							'id',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Activity))))))));
var _user$project$Main$decodeStream = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'orderedItems',
	_elm_lang$core$Json_Decode$list(_user$project$Main$decodeActivity),
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'type',
		_elm_lang$core$Json_Decode$string,
		A3(
			...
			A3(
				...
				'@context',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Main$Stream)))));
var _user$project$Main$requestStream = function (stream) {
	return A2(_elm_lang$http$Http$get, stream, _user$project$Main$decodeStream);
};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {streamInput: a, streamContent: b};
	});
var _user$project$Main$StreamResponse = function (a) {
	return {ctor: 'StreamResponse', _0: a};
};
var _user$project$Main$init = function (location) {
	var _p1 = _user$project$Main$parseRoute(location);
	if (_p1.ctor === 'Just') {
		var _p2 = _p1._0;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{streamInput: _p2, streamContent: _krisajenkins$remotedata$RemoteData$Loading},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Cmd$map,
					_user$project$Main$StreamResponse,
					_krisajenkins$remotedata$RemoteData$sendRequest(
						_user$project$Main$requestStream(_p2))),
				_1: {ctor: '[]'}
			});
	} else {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{streamInput: '', streamContent: _krisajenkins$remotedata$RemoteData$NotAsked},
			{ctor: '[]'});
	}
};
		...
		switch (_p3.ctor) {
			...
			case 'LoadStream':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{streamContent: _krisajenkins$remotedata$RemoteData$Loading}),
					{
						ctor: '::',
						_0: _user$project$Main$navigate(
							_elm_lang$core$Maybe$Just(model.streamInput)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$core$Platform_Cmd$map,
								_user$project$Main$StreamResponse,
								_krisajenkins$remotedata$RemoteData$sendRequest(
									_user$project$Main$requestStream(model.streamInput))),
							_1: {ctor: '[]'}
						}
					});
			default:
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							streamContent: A2(_elm_lang$core$Debug$log, 'response', _p3._0)
						}),
					{ctor: '[]'});
		}
	});
var _user$project$Main$LoadStream = {ctor: 'LoadStream'};
var _user$project$Main$StreamInput = function (a) {
	return {ctor: 'StreamInput', _0: a};
};
	...
	return A2(
		...
		{ctor: '[]'},
		{
										...
										},
										{
											...
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('Activity Stream URL'),
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$defaultValue(model.streamInput),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$StreamInput),
																_1: {ctor: '[]'}
															}
														}
													}
															...
															_0: _elm_lang$html$Html_Attributes$classList(
																{
																	...
																	_0: {
																		ctor: '_Tuple2',
																		_0: 'is-loading',
																		_1: _krisajenkins$remotedata$RemoteData$isLoading(model.streamContent)
																	},
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$LoadStream),
																_1: {ctor: '[]'}
															}
														}
													},
			...
			_1: {
				ctor: '::',
				_0: function () {
					var _p4 = model.streamContent;
					if (_p4.ctor === 'Success') {
						return _user$project$Main$streamView(_p4._0);
					} else {
